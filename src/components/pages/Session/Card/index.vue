...
const emit = defineEmits(["hideCard, onStart, onEnd, onSkip, "]);
...
<template>
  <div
    ...
    ref="cardRef"
    :class="[
      'main-card absolute bg-white rounded-[16px] shadow-custom overflow-hidden w-full h-full min-h-[416px] max-h-[900px] min-w-[288px] max-w-[450px]',
    ]"
  >
    <slot />
  </div>
